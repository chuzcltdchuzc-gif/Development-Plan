...
ParcelService, shape the response. No business logic lives here.
ParcelService is built fresh per request (Depends(get_parcel_service)) —
same reasoning as app.contexts.identity.dependencies for AuthService/
AdminService: never a fixed instance shared across concurrent requests.
"""
from __future__ import annotations

from fastapi import APIRouter, Depends

from app.contexts.registry.api.dtos import CreateParcelRequest
