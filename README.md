...
| [`docs/CONSTITUTIONAL_RECOMMENDATIONS.md`](./docs/CONSTITUTIONAL_RECOMMENDATIONS.md) | Recorded (not adopted) recommendations for the eventual LV-000 constitutional document |
