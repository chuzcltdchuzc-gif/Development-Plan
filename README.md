...
| [`docs/adr/`](./docs/adr/) | Architecture Decision Records — ADR-001 through ADR-017 (accepted), ADR-018 (proposed, pending review) |
...
| [`docs/B4_THREAT_MODEL.md`](./docs/B4_THREAT_MODEL.md) | B4's required threat model/trust-boundary analysis — gates ADR-018, no code yet |
