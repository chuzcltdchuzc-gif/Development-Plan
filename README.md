...
| [`docs/adr/`](./docs/adr/) | Architecture Decision Records — ADR-001 through ADR-019 accepted; ADR-022 (Spatial Authorization Model) proposed, pending review |
...
| [`docs/B4_VERIFICATION_CHECKLIST.md`](./docs/B4_VERIFICATION_CHECKLIST.md) | B4's deferred-verification register (Slice 1 onward) — what must pass before the eventual B4 Quality Gate |
